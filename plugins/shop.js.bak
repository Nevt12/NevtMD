...
*🍾 Botol:* ${Bbotol}
*💍 Berlian:* ${Bberlian}
*🟨 Emasbatang:* ${Bemasbatang}
*🟡 Emasbiasa:* ${Bemasbiasa}
...
*🍾 Botol:* ${Sbotol}
*💍 Berlian:* ${Sberlian}
*🟨 Emasbatang:* ${Semasbatang}
*🟡 Emasbiasa:* ${Semasbiasa}
                ...
                case 'foodpet':
                    ...
                    case 'limit':
                            if (global.db.data.users[m.sender].money >= Blimit * count) {
                                ...
                                conn.reply(m.chat, `✔️Succes membeli ${count} Limit ⭐ dengan harga ${Blimit * count} money💹`, m)
                            } else conn.reply(m.chat, `Uang anda tidak cukup untuk membeli ${count} limit dengan harga ${Blimit * count} money`, m)
                    ...
                    case 'emasbiasa':
                            if (global.db.data.users[m.sender].money >= Bemasbiasa * count) {
                                global.db.data.users[m.sender].emasbiasa += count * 1
                                global.db.data.users[m.sender].money -= Bemasbiasa * count
                                conn.reply(m.chat, `Succes membeli ${count} Emas Biasa dengan harga ${Bemasbiasa * count} money`, m)
                            } else conn.reply(m.chat, `Uang anda tidak cukup untuk membeli ${count} emas biasa dengan harga ${Bemasbiasa * count} money`.trim(), m)
                        
                        break 
                     case 'emasbatang':
                            if (global.db.data.users[m.sender].money >= Bemasbatang * count) {
                                global.db.data.users[m.sender].emasbatang += count * 1
                                global.db.data.users[m.sender].money -= Bemasbatang * count
                                conn.reply(m.chat, `Succes membeli ${count} Emas Batang dengan harga ${Bemasbatang * count} money`, m)
                            } else conn.reply(m.chat, `Uang anda tidak cukup untuk membeli ${count} emas batang dengan harga ${Bemasbatang * count} money`.trim(), m)
            ...
            case 'sell': 
                switch (_type) {
                    ...
                    case 'berlian':
                        ...
                        break
                   case 'emasbiasa':
                        if (global.db.data.users[m.sender].emasbiasa >= count * 1) {
                            global.db.data.users[m.sender].emasbiasa -= count * 1
                            global.db.data.users[m.sender].money += Semasbiasa * count
                            conn.reply(m.chat, `Succes menjual ${count} emasbiasa, dan anda mendapatkan ${Semasbiasa * count} money`, m)
                        } else conn.reply(m.chat, `EmasBiasa anda tidak cukup`, m)
                        break 
                    case 'emasbatang':
                        if (global.db.data.users[m.sender].emasbatang >= count * 1) {
                            global.db.data.users[m.sender].emasbatang -= count * 1
                            global.db.data.users[m.sender].money += Semasbatang * count
                            conn.reply(m.chat, `Succes menjual ${count} emasbatang, dan anda mendapatkan ${Semasbatang * count} money`, m)
                        } else conn.reply(m.chat, `EmasBatang anda tidak cukup`, m)
                        break 
                    case 'diamond':
                     ...
                     case 'limit':
                        if (global.db.data.users[m.sender].limit >= count * 1) {
                            ...
                            conn.reply(m.chat, `✔️Succes menjual ${count} limit ⭐, dan anda mendapatkan ${Slimit * count} money💹`, m)
